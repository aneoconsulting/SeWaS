...
namespace SWS
{
  ...
  */
  ...
  // // (ts, ii, jj, kk)(i, j, k)
  // typedef Eigen::Tensor<SpatialBlockField<RealType>, 1+DIM, Eigen::AutoAlign> TimeSpatialField;
  ...
  // typedef Map<Eigen::Array<RealType, NB_LOCATIONS, Eigen::Dynamic, Eigen::ColMajor|Eigen::AutoAlign>, Eigen::Aligned64> Halo;
