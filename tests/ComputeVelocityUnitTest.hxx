...
protected:
  void SetUp() override
  {
    ...
    ASSERT_NE(nullptr, Mesh3DPartitioning::getInstance(cx_, cy_, cz_,
                                                       hnx, hny, hnz,
                                                       P_, Q_, R_));
  ...
  void TearDown() override
  {
    ...
    for (auto l : {SWS::Locations::LEFT, SWS::Locations::RIGHT, SWS::Locations::BACKWARD, SWS::Locations::FORWARD, SWS::Locations::BOTTOM, SWS::Locations::TOP}){
...
private:
  void buildArenas(SWS::Halo & halo,
                   const int lii, const int ljj, const int lkk)
  {
    for (auto l : {SWS::Locations::LEFT, SWS::Locations::RIGHT, SWS::Locations::BACKWARD, SWS::Locations::FORWARD, SWS::Locations::BOTTOM, SWS::Locations::TOP}){
...
protected:
  ...
  static inline char * argv_[] = {"sewas",
                                  "--cx", "4",
                                  "--cy", "4",
                                  "--cz", "4",
                                  "--P", "1",
